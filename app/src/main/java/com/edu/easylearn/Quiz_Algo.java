...
public class Quiz_Algo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz__algo);
        ...
        logout_ic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toasty.success(Quiz_Algo.this,"Sign out effettuato", Toast.LENGTH_LONG).show();
                startActivity(new Intent(Quiz_Algo.this,Login.class));
            }
        });
        ...
        riversRef.putFile(img_uri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        pd.dismiss();
                        Toasty.success(Quiz_Algo.this,"Foto caricata", Toast.LENGTH_LONG).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        pd.dismiss();
                        Toasty.error(Quiz_Algo.this,"Foto non caricata",Toast.LENGTH_LONG).show();
                    }
    ...
    public void ClickLogo(View view) {
        //Close drawer
        startActivity(new Intent(Quiz_Algo.this,Home.class));
...
//    }
    ...
    public void ClickCondividi(View view) {
        ...
        try {
            ...
            Toasty.error(Quiz_Algo.this,"Errore condivisione",Toast.LENGTH_LONG).show();
        }
    }
