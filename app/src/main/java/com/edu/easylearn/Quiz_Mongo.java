...
public class Quiz_Mongo extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz__mongo);
        ...
        loadingDialog = new Dialog(Quiz_Mongo.this);
        ...
        logout_ic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toasty.success(Quiz_Mongo.this,"Sign out effettuato", Toast.LENGTH_LONG).show();
                startActivity(new Intent(Quiz_Mongo.this,Login.class));
            }
        });
        ...
        back_quiz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Quiz_Mongo.this,Quiz_Db.class));
            }
        });
    ...
    private void getQuestionList(){
        ...
        firestore.collection("QUIZ").document("CAT_2")
                .collection("MONGO").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    Toasty.error(Quiz_Mongo.this,"Errore nel caricamento delle domande...", Toast.LENGTH_LONG).show();
                }
    ...
    private void changeQuestion(){
        ...
        if(quesNum < questionsList.size() - 1){
            ...
            Intent intent = new Intent(Quiz_Mongo.this,Score_Mongo.class);
        ...
        riversRef.putFile(img_uri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        pd.dismiss();
                        Toasty.success(Quiz_Mongo.this,"Foto caricata", Toast.LENGTH_LONG).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        pd.dismiss();
                        Toasty.error(Quiz_Mongo.this,"Foto non caricata",Toast.LENGTH_LONG).show();
                    }
    ...
    public void ClickLogo(View view) {
        //Close drawer
        startActivity(new Intent(Quiz_Mongo.this,Home.class));
...
//    }
    ...
    public void ClickCondividi(View view) {
        ...
        try {
            ...
            Toasty.error(Quiz_Mongo.this,"Errore condivisione",Toast.LENGTH_LONG).show();
        }
    }
