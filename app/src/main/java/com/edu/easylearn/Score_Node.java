...
public class Score_Node extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_score__node);
        ...
        logout_ic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toasty.success(Score_Node.this,"Sign out effettuato", Toast.LENGTH_LONG).show();
                startActivity(new Intent(Score_Node.this,Login.class));
            }
        });
        ...
        riprova.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Score_Node.this,Quiz_Node.class));
            }
        });
        ...
        corso.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Score_Node.this,NodeJS.class));
            }
        });
        ...
        termina.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Score_Node.this,Quiz_Web.class));
            }
        });
        ...
        riversRef.putFile(img_uri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        pd.dismiss();
                        Toasty.success(Score_Node.this,"Foto caricata", Toast.LENGTH_LONG).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        pd.dismiss();
                        Toasty.error(Score_Node.this,"Foto non caricata",Toast.LENGTH_LONG).show();
                    }
    ...
    public void ClickLogo(View view) {
        //Close drawer
        startActivity(new Intent(Score_Node.this,Home.class));
...
//    }
    ...
    public void ClickCondividi(View view) {
        ...
        try {
            ...
            Toasty.error(Score_Node.this,"Errore condivisione",Toast.LENGTH_LONG).show();
        }
    }
