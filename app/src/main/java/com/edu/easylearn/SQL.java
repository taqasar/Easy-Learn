...
public class SQL extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent home_intent = new Intent(SQL.this,Database.class);
        ...
        quiz_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent quiz_intent = new Intent(SQL.this,Quiz_SQL.class);
        ...
        back_arrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back_home = new Intent(SQL.this, Database.class);
        ...
        logout_ic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toasty.success(SQL.this,"Sign out effettuato", Toast.LENGTH_LONG).show();
                startActivity(new Intent(SQL.this,Login.class));
            }
        });
        ...
        riversRef.putFile(img_uri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        pd.dismiss();
                        Toasty.success(SQL.this,"Foto caricata", Toast.LENGTH_LONG).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        pd.dismiss();
                        Toasty.error(SQL.this,"Foto non caricata",Toast.LENGTH_LONG).show();
                    }
    ...
    public void ClickLogo(View view) {
        //Close drawer
        startActivity(new Intent(SQL.this,Home.class));
...
//    }
    ...
    public void ClickCondividi(View view) {
        ...
        try {
            ...
            Toasty.error(SQL.this,"Errore condivisione",Toast.LENGTH_LONG).show();
        }
    }
