...
public class Quiz_JS extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz__j_s);
        ...
        loadingDialog = new Dialog(Quiz_JS.this);
        ...
        logout_ic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toasty.success(Quiz_JS.this,"Sign out effettuato", Toast.LENGTH_LONG).show();
                startActivity(new Intent(Quiz_JS.this,Login.class));
            }
        });
        ...
        back_quiz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Quiz_JS.this,Quiz_Web.class));
            }
        });
    ...
    private void getQuestionList(){
        ...
        firestore.collection("QUIZ").document("CAT_1")
                .collection("JS").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    Toasty.error(Quiz_JS.this,"Errore nel caricamento delle domande...", Toast.LENGTH_LONG).show();
                }
    ...
    private void changeQuestion(){
        ...
        if(quesNum < questionsList.size() - 1){
            ...
            Intent intent = new Intent(Quiz_JS.this,Score_JS.class);
        ...
        riversRef.putFile(img_uri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        pd.dismiss();
                        Toasty.success(Quiz_JS.this,"Foto caricata", Toast.LENGTH_LONG).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        pd.dismiss();
                        Toasty.error(Quiz_JS.this,"Foto non caricata",Toast.LENGTH_LONG).show();
                    }
    ...
    public void ClickLogo(View view) {
        //Close drawer
        startActivity(new Intent(Quiz_JS.this,Home.class));
...
//    }
    ...
    public void ClickCondividi(View view) {
        ...
        try {
            ...
            Toasty.error(Quiz_JS.this,"Errore condivisione",Toast.LENGTH_LONG).show();
        }
    }
