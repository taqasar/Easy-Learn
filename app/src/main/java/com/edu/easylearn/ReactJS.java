...
public class ReactJS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_react_j_s);
        ...
        String videoPath ="android.resource://" + getPackageName() + "/" + R.raw.tutorialreact;
        ...
        home_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent home_intent = new Intent(ReactJS.this,SviluppoWeb.class);
        ...
        quiz_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent quiz_intent = new Intent(ReactJS.this,Quiz_React.class);
        ...
        back_arrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back_home = new Intent(ReactJS.this, SviluppoWeb.class);
        ...
        logout_ic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toasty.success(ReactJS.this,"Sign out effettuato", Toast.LENGTH_LONG).show();
                startActivity(new Intent(ReactJS.this,Login.class));
            }
        });
        ...
        riversRef.putFile(img_uri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        pd.dismiss();
                        Toasty.success(ReactJS.this,"Foto caricata", Toast.LENGTH_LONG).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        pd.dismiss();
                        Toasty.error(ReactJS.this,"Foto non caricata",Toast.LENGTH_LONG).show();
                    }
    ...
    public void ClickLogo(View view) {
        //Close drawer
        startActivity(new Intent(ReactJS.this,Home.class));
...
//    }
    ...
    public void ClickCondividi(View view) {
        ...
        try {
            ...
            Toasty.error(ReactJS.this,"Errore condivisione",Toast.LENGTH_LONG).show();
        }
    }
