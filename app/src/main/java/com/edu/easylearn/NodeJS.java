...
public class NodeJS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_node_j_s);
        getSupportActionBar().hide();



        VideoView videoView = findViewById(R.id.video_view);
        String videoPath ="android.resource://" + getPackageName() + "/" + R.raw.videonode;
        ...
        home_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent home_intent = new Intent(NodeJS.this,SviluppoWeb.class);
        ...
        quiz_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent quiz_intent = new Intent(NodeJS.this,Quiz_Node.class);
        ...
        back_arrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back_home = new Intent(NodeJS.this, SviluppoWeb.class);
        ...
        logout_ic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toasty.success(NodeJS.this,"Sign out effettuato", Toast.LENGTH_LONG).show();
                startActivity(new Intent(NodeJS.this,Login.class));
            }
        });
        ...
        riversRef.putFile(img_uri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        pd.dismiss();
                        Toasty.success(NodeJS.this,"Foto caricata", Toast.LENGTH_LONG).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        pd.dismiss();
                        Toasty.error(NodeJS.this,"Foto non caricata",Toast.LENGTH_LONG).show();
                    }
    ...
    public void ClickLogo(View view) {
        //Close drawer
        startActivity(new Intent(NodeJS.this,Home.class));
...
//    }
    ...
    public void ClickCondividi(View view) {
        ...
        try {
            ...
            Toasty.error(NodeJS.this,"Errore condivisione",Toast.LENGTH_LONG).show();
        }
    }
