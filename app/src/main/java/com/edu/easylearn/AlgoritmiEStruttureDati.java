...
public class AlgoritmiEStruttureDati extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout_ic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toasty.success(AlgoritmiEStruttureDati.this, "Sign out effettuato", Toast.LENGTH_LONG).show();
                startActivity(new Intent(AlgoritmiEStruttureDati.this, Login.class));
            }
        });
        ...
        riversRef.putFile(img_uri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        pd.dismiss();
                        Toasty.success(AlgoritmiEStruttureDati.this, "Foto caricata", Toast.LENGTH_LONG).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        pd.dismiss();
                        Toasty.error(AlgoritmiEStruttureDati.this, "Foto non caricata", Toast.LENGTH_LONG).show();
                    }
    ...
    public void ClickLogo(View view) {
        //Close drawer
        startActivity(new Intent(AlgoritmiEStruttureDati.this, Home.class));
...
//    }
    ...
    public void ClickCondividi(View view) {
        ...
        try {
            ...
            Toasty.error(AlgoritmiEStruttureDati.this, "Errore condivisione", Toast.LENGTH_LONG).show();
        }
    }
